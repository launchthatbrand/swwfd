...
import { Command, CommandItem, CommandList } from "@launchthatapp/ui/command";
...
const LexicalContextMenuPlugin = lazyClient(
  () => import("./default/lexical-context-menu-plugin"),
) as typeof import("./default/lexical-context-menu-plugin").default;
