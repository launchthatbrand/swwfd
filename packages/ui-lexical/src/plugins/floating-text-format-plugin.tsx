...
import { ToggleGroup, ToggleGroupItem } from "@launchthatapp/ui/toggle-group";
...
function FloatingTextFormat({
  ...
  return (
    <div
      ...
      className="absolute left-0 top-0 z-10 flex gap-1 rounded-md border bg-background p-1 opacity-0 shadow-md transition-opacity duration-300 will-change-transform"
    >
      {editor.isEditable() && (
        <>
          <ToggleGroup
